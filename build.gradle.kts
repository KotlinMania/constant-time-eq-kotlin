...
kotlin {
    ...
    val xcf = XCFramework("ConstantTimeEq")
    ...
    swiftExport {
        moduleName = "ConstantTimeEq"
        flattenPackage = "io.github.kotlinmania.constanttimeeq"
    }

    android {
        namespace = "io.github.kotlinmania.constanttimeeq"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "constant-time-eq-kotlin", version.toString())

    pom {
        name.set("constant-time-eq-kotlin")
        description.set("Kotlin Multiplatform port of cesarb/constant_time_eq - Compares two equal-sized byte strings in constant time")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/constant-time-eq-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/constant-time-eq-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/constant-time-eq-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/constant-time-eq-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "embedSwiftExportForXcode",
    "assembleConstantTimeEqXCFramework",
    "assembleConstantTimeEqDebugXCFramework",
    "assembleConstantTimeEqReleaseXCFramework",
    "assembleDebugIosFatFrameworkForConstantTimeEqXCFramework",
    "assembleReleaseIosFatFrameworkForConstantTimeEqXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForConstantTimeEqXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForConstantTimeEqXCFramework",
    "assembleDebugMacosFatFrameworkForConstantTimeEqXCFramework",
    "assembleReleaseMacosFatFrameworkForConstantTimeEqXCFramework",
    "assembleDebugTvosFatFrameworkForConstantTimeEqXCFramework",
    "assembleReleaseTvosFatFrameworkForConstantTimeEqXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForConstantTimeEqXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForConstantTimeEqXCFramework",
    "assembleDebugWatchosFatFrameworkForConstantTimeEqXCFramework",
    "assembleReleaseWatchosFatFrameworkForConstantTimeEqXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForConstantTimeEqXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForConstantTimeEqXCFramework",
