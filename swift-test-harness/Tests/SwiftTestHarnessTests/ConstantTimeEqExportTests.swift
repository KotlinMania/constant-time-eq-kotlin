...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `ConstantTimeEq.swiftmodule/`
...
//      `import ConstantTimeEq` above would fail at compile time.
//
//   2. The static archive `libConstantTimeEq.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "ConstantTimeEq" }` and
//      `flattenPackage = "io.github.kotlinmania.constanttimeeq"` configuration in
...
//      via the `ConstantTimeEqLibrary` product.
//
...
final class ConstantTimeEqExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "ConstantTimeEq swift module imported cleanly")
    }
}
