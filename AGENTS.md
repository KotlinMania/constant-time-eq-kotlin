...
This file is the quick-reference operating contract for constant-time-eq-kotlin. The longer
...
constant-time-eq-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`constant_time_eq`](https://crates.io/crates/constant_time_eq). Upstream Rust is the behavioral oracle while the
